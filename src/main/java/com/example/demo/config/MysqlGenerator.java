...
public class MysqlGenerator {
    ...
    private static final String OUT_PATH = "F:\\IntelliJ IDEA\\works\\SpringBootStudy_oKong\\src\\main";
    private static final String AUTHOR = "zhong";

    private static final String DRIVER = "com.mysql.cj.jdbc.Driver";
    private static final String URL = "jdbc:mysql://192.168.6.41:3306/test?useUnicode=true&characterEncoding=UTF-8";
    private static final String USER_NAME = "mysql";
    private static final String PASSWORD = "nJDNZtWsJJdftbYGrVOB";
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                // 全局配置
                new GlobalConfig().setOutputDir(OUT_PATH + "/java")// 输出目录
